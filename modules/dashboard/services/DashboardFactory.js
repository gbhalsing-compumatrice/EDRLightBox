angular.module('EDRLightbox').factory('DashboardService', ['$http',  function ($http) {
    ...
    dashboardService.getColumnFilterList = function () {

        return $http.get('json/ColumnFilterList.js').then(
            function (results) {
                return results.data;
            })
    }
    ...
    dashboardService.getAddressList = function () {

        return $http.get('json/AddressList.js').then(
            function (results) {
                return results.data;
            })
    }
