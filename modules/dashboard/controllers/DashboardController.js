angular.module('EDRLightbox').controller('DashboardController', ['$scope', '$state', '$location', '$document', '$timeout', '$http', '$filter', 'NgTableParams', 'DashboardService', '$modal', function ($scope, $state, $location, $document, $timeout, $http, $filter, NgTableParams, DashboardService, $modal) {
    ...
    $scope.setRowFilter = function (id) {
      
        var checkClass = $("#" + id).hasClass("tableicongray fa fa-circle");
        
        if (checkClass) {

            $("#" + id).removeClass('tableicongray fa fa-circle');

            $("#" + id).addClass('tableicongreen fa fa-check-circle');
        }

        else if ($("#" + id).hasClass("tableicongreen fa fa-check-circle")) {

            $("#" + id).removeClass('tableicongreen fa fa-check-circle');

            $("#" + id).addClass('tableicon fa fa-ban');
        }

        else if ($("#" + id).hasClass("tableicon fa fa-ban")) {

            $("#" + id).removeClass('tableicon fa fa-ban');

            $("#" + id).addClass('tableicongray fa fa-circle');
        }
    }
    ...
    $scope.getSelectedRowData = function (siteid) {
        ...
        var checkclick = $("#" + siteid).hasClass('tableicon fa fa-ban');
